...
package uk.ac.dotrural.smile.service;

/**
 * @see uk.ac.dotrural.smile.service.SmileService
 */
...
import	uk.ac.dotrural.smile.entity.photo.Photo;
...
public class SmileServiceBeanImpl
    extends SmileServiceBean
    implements SmileService /*Implement the SmileService interface*/
{
...
//-----------------Internal crud methods Implementation--------------------
    ...
    protected java.lang.Object handleCreateNewRecord(org.hibernate.Session session, java.lang.Object newRecord, uk.ac.dotrural.smile.entity.activity.Activity aTrail)
	{
    ...
    protected void handleUpdateRecord(org.hibernate.Session session, java.lang.Object existingRecord,  uk.ac.dotrural.smile.entity.activity.Activity aTrail)
	{	
    ...
    protected void handleDeleteRecord(org.hibernate.Session session, java.lang.Object existingRecord,  uk.ac.dotrural.smile.entity.activity.Activity aTrail)
	{		
